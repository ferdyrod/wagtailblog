...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PublicidadPage'
        db.delete_table(u'blog_publicidadpage')

        # Adding model 'Publicidad'
        db.create_table(u'blog_publicidad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('imagen', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image'])),
        ))
        db.send_create_signal(u'blog', ['Publicidad'])


    def backwards(self, orm):
        # Adding model 'PublicidadPage'
        db.create_table(u'blog_publicidadpage', (
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('imagen', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailimages.Image'], on_delete=models.SET_NULL, blank=True)),
        ))
        db.send_create_signal(u'blog', ['PublicidadPage'])

        # Deleting model 'Publicidad'
        db.delete_table(u'blog_publicidad')
    ...
    models = {
        ...
        u'blog.blogindexpagerelatedlink': {
            ...
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['blog.BlogIndexPage']"}),
        ...
        u'blog.blogpage': {
            ...
            'imagen': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'resumen': ('wagtail.wagtailcore.fields.RichTextField', [], {})
        },
        u'blog.blogpagerelatedlink': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'BlogPageRelatedLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_external': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['blog.BlogPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'blog.blogpagetag': {
