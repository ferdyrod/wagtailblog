...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_formpage', (
            ...
            ('texto_agradecimiento', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
        ))
        db.send_create_signal(u'blog', ['FormPage'])

        # Adding model 'FormField'
        db.create_table(u'blog_formfield', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='form_fields', to=orm['blog.FormPage'])),
        ))
        db.send_create_signal(u'blog', ['FormField'])


    def backwards(self, orm):
        # Deleting model 'FormPage'
        db.delete_table(u'blog_formpage')

        # Deleting model 'FormField'
        db.delete_table(u'blog_formfield')
    ...
    models = {
        ...
        u'blog.formfield': {
            ...
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'form_fields'", 'to': u"orm['blog.FormPage']"}),
